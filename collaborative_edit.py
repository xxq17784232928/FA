...
def parse_args():
    ...
    parser.add_argument("--imagic_text_folder",type=str,default="outputpretrained/text_edit/27044.jpg/He is a teen. The face is covered with short pointed beard.",help="path to Imagic text-based editing results")
    parser.add_argument("--imagic_mask_folder",type=str,default="outputpretrained/mask_edit/27044.jpg/27044_0_remove_smile_and_rings.png",help="path to Imagic mask-based editing results")
    ...
    parser.add_argument("--save_folder",type=str,default="outputpretrained/collaborative_edit",help="folder to save editing outputs")
